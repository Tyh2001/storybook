...
// Step 2: 创建一个网络服务类来获取数据
class CatAPIService {
    func fetchCatImages(completion: @escaping ([CatImage]) -> Void) {
        let urlString = "https://api.thecatapi.com/v1/images/search?limit=10&page=1"
...
struct DemoView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            // Step 4: 获取数据
            apiService.fetchCatImages { images in
                catImages = images
            }
        }
    }
