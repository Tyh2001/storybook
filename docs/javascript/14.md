...
可创建文档片段，如果一次性需要在 DOM 中添加多个元素，可以先试用它来创建一个临时的文档片段，最终统一将需要添加的节点插入 DOM 树，避免频繁修改 DOM 树导致大量重绘
...
```js
console.log(crypto.randomUUID()) // f99f4d17-816f-4cbe-8c66-9a059c84410e
```
