...
<span class="line"><span>          PUBLISH_DIR: ./dist # 部署目录</span></span></code></pre></div><p>配置好之后，将项目推送至远程仓库，即可自动部署了。</p><h2 id="一些问题" tabindex="-1">一些问题 <a class="header-anchor" href="#一些问题" aria-label="Permalink to &quot;一些问题&quot;">​</a></h2><ul><li>怎么查看部署？</li></ul><p>在远程仓库的 <code>Actions</code> 中可以查看是否部署完成。</p><ul><li>怎么更新？</li></ul><p>不需要手动更新，更改代码之后，直接提交，就会自动打包部署了。</p><ul><li>怎么查看部署地址？</li></ul><p>在远程仓库的 <code>Setting / page</code>，中查看部署的地址和分支。</p>`,36),c=[l];function i(o,t,d,r,h,u){return n(),s("div",null,c)}const m=a(p,[["render",i]]);export{b as __pageData,m as default};
