import{_ as s,o as n,c as a,a as l}from"./app.7748d0de.js";const D=JSON.parse('{"title":"Windows 命令","description":"","frontmatter":{},"headers":[{"level":2,"title":"目录操作","slug":"目录操作","link":"#目录操作","children":[]},{"level":2,"title":"文件操作","slug":"文件操作","link":"#文件操作","children":[]},{"level":2,"title":"编辑文件","slug":"编辑文件","link":"#编辑文件","children":[]}],"relativePath":"docs/system/system-1.md"}'),p={name:"docs/system/system-1.md"},e=l(`<h1 id="windows-命令" tabindex="-1">Windows 命令 <a class="header-anchor" href="#windows-命令" aria-hidden="true">#</a></h1><h2 id="目录操作" tabindex="-1">目录操作 <a class="header-anchor" href="#目录操作" aria-hidden="true">#</a></h2><div class="language-shell"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 进入目录</span></span>
...
<span class="line"></span></code></pre></div><h2 id="编辑文件" tabindex="-1">编辑文件 <a class="header-anchor" href="#编辑文件" aria-hidden="true">#</a></h2>`,6),o=[e];function t(c,r,i,y,B,d){return n(),a("div",null,o)}const C=s(p,[["render",t]]);export{D as __pageData,C as default};
